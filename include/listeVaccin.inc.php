...
<div class="triche">
    <section id="Vaccin">
        ...
        <div class="clear"></div>
        <div >
            </br> <h2>Les vaccins en France</h2></br>
            ...
            </br> <p> Tous les vaccins obligatoires ou recommandés sont remboursés.</p>
        ...
        <div>
            </br> <h2>Les vaccins de base actuellement recommandés en France sont les suivants :</h2>
    </br>
                <p> - Diphtérie-Tétanos-Poliomyélite (DTP) (nourrissons dès l'âge de 2 mois, enfants, adolescents, adultes, seniors)</p>
                <p> - Coqueluche (nourrissons dès l'âge de 2 mois, enfants, adolescents et jeunes adultes)</p>
                <p> - Haemophilus influenzae (Hib) (nourrissons dès l'âge de 2 mois, enfants jusqu'à 5 ans)</p>
                <p> - Hépatite B (de la naissance à l'adolescence)</p>
                <p> - Pneumococcique conjugué (PCV7) (nourrissons dès l'âge de 2 mois, enfants jusqu'à 2 ans)</p>
                <p> - Méningocoque C ( à 5 et 12 mois)</p>
                <p> - Rougeole-Oreillons-Rubéole (ROR) (dès 12 mois)</p>
                <p> - Papillomavirus humain (HPV) - le cancer du col de l'utérus (pour les adolescentes dès 14 ans)</p>
                <p> - Varicelle (adolescents et jeunes adultes non immunisés)</p>
                <p> - Grippe (dès 65 ans, groupes à risque et professions de santé)</p>
                <p> - BCG (nourrissons appartenant à des groupes à risque)</p>

        </div>
        <div>
            </br> <h2> Effets secondaires des vaccins</h2>
            </br>
            ...
            <p>Celles-ci ont par exemple permis de démontrer :</p>
                ...
                <p>- que la vaccination des nourrissons ne joue aucun rôle déclenchant dans la mort subite des nourrissons</p>
                <p>- que le vaccin coqueluche ne provoque pas de dommages cérébraux</p>
                <p>- que le vaccin rougeole-rubéole-oreillons n’augmente pas le risque d’autisme</p>
                <p>- que la vaccination contre les méningites à Hib n’augmente pas le risque de diabète</p>
                <p>- que la vaccination contre l’hépatite B n’augmente pas le risque de sclérose en plaques</p>
                <p>- que la vaccination contre les papillomavirus n'augmente pas le risque de sclérose en plaques ou d'autres maladies auto-immune</p>
            </br>
        </div>
        <div class="clear"></div>
</div>
